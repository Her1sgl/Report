...
; Создание ярлыков
; Ярлык в меню Пуск
Name: "{group}\Auto Report"; Filename: "{app}\main.exe"; IconFilename: "{app}\icon.ico"
...
Name: "{autodesktop}\Auto Report"; Filename: "{app}\main.exe"; IconFilename: "{app}\icon.ico"; Tasks: desktopicon

[Run]
; Опционально: запустить приложение после установки
Filename: "{app}\main.exe"; Description: "{cm:LaunchProgram,Auto Report}"; Flags: nowait postinstall skipifsilent
